    ...
    <div className="flex bg-gray-100 min-h-screen relative">
      ...
      <div
        className={`${showSideBarAtResponsivePhase ? "block absolute z-50" : "hidden"
          } lg:flex justify-between bg-gradient-to-b from-blue-600 to-blue-400 text-white  flex-col h-screen transition-all duration-500 ease-in-out ${isSidebarExpanded || isHovered
