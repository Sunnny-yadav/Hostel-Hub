...
import { getLogedInUserData, getMatchedProfileStudents, login_User, register_User } from '../controllers/user.controller.js';
...
router.route("/login").post(validateShema(loginSchema),login_User);
router.route("/getUserData").get(verifyJWT, getLogedInUserData);
router.route("/get-matched-profiles").get(verifyJWT, getMatchedProfileStudents)
